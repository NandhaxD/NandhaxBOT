...
async def help_commnds(_, query):
   ...
   help = data[0]['help']
   return await bot.inline_edit_text(inline_message_id=query.message.id, text=strings.HELP_CMD.format(module=module, help=help), parse_mode=enums.ParseMode.MARKDOWN)
