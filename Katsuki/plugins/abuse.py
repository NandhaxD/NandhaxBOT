# To use random strings 
import random

# The Client
from Katsuki import katsuki

# Importing Handler to use command and owner id 
...
@katsuki.on_message(filters.command("abuse", prefixes=HANDLER) & filters.user(OWNER_ID))
async def abuse(_, m):
  # GOING TO SEND RANDOM ABUSE MESSAGE
  await m.edit_text(random.choice(ABUSE))
